  ...
  for (var index = 0; index < zones.length; index += 1) {
    ...
    cards.push({
      ...
      value: {
        ...
        appearance: { accent: zone.paused ? "PLUGIN_ACCENT_ORANGE" : stateAccent(zone.status), iconSource: { systemName: "globe.asia.australia.fill" }, variant: "PLUGIN_COMPONENT_VARIANT_TINTED" },
