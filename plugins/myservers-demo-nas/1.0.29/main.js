...
function demoComponentCatalog(ctx, label) {
  ...
  const stateCustomComponent = {
    ...
    stateBlock: {
      ...
      iconUrl: "https://myservers.plus/images/logo.png",
      appearance: { accent: demoAccent(ctx), icon: "server.rack" }
    }
  };
  ...
  const iconComponent = {
    ...
    icon: {
      ...
      url: "https://myservers.plus/images/logo.png",
      appearance: { accent: demoAccent(ctx), size: "PLUGIN_COMPONENT_SIZE_LARGE" }
    }
  };
