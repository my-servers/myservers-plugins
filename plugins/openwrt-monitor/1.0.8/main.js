...
function overviewPage(ctx, snapshot) {
  ...
  var resourceChildren = [
    cpu.available
      ...
      : valueComponent("openwrt-load", "系统负载", "标准 OpenWrt RPC · 最近 1 分钟", load, "PLUGIN_VALUE_FORMAT_NUMBER", load > 1.5 ? "PLUGIN_ACCENT_ORANGE" : "PLUGIN_ACCENT_GREEN", "speedometer", load > 1.5 ? "PLUGIN_STATUS_WARNING" : "PLUGIN_STATUS_HEALTHY"),
