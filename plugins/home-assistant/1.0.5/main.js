  ...
  for (var index = 0; index < domains.length; index += 1) {
    ...
    cards.push({
      ...
      card: {
        ...
        onTap: { navigate: { surface: "detail", route: "domain:" + domain + ":0" } },
        children: [{
          id: "ha-domain-card-layout-" + domain,
          stack: {
            ...
            children: [
              {
                ...
                stack: {
                  ...
                  children: [
                    ...
                    { id: "ha-domain-card-spacer-" + domain, spacer: { length: 0 } },
                    {
                      id: "ha-domain-card-count-" + domain,
                      text: {
              ...
              {
                id: "ha-domain-card-title-" + domain,
                text: {
              ...
              {
                id: "ha-domain-card-subtitle-" + domain,
                text: {
                  text: unavailable > 0 ? unavailable + " 个不可用" : "全部可用",
